...
try
{
    ...
    */
    ...
    builder.Services.Configure<ForwardedHeadersOptions>(options =>
    {
        ...
        options.KnownIPNetworks.Add(new System.Net.IPNetwork(IPAddress.Parse("10.0.0.0"), 16)); // Load Balancer / VPC Network
    });
    ...
    app.UseWebSockets();
    app.UseSwaggerUI(c => c.SwaggerEndpoint($"{pathBase}/openapi/AspNetCoreWebApi.json", "AspNetCoreWebApi V10.0"));
