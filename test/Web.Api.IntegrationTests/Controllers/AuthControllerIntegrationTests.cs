...
public class AuthControllerIntegrationTests
{
    ...
    public async Task CanExchangeValidRefreshToken()
    {
        ...
        var refreshTokenResponse = await _client.PostAsync("/api/auth/refreshtoken", new StringContent(JsonSerializer.Serialize(new Models.Request.ExchangeRefreshTokenRequest(token, refreshToken)), Encoding.UTF8, "application/json"));
