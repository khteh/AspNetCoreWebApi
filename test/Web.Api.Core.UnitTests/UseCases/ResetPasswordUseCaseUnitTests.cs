...
namespace Web.Api.Core.UnitTests.UseCases
{
    ...
    {
        [Fact]
        public async void Handle_ResetPassword_ShouldSucceed()
        {
            // arrange
            ...
            var useCase = new ResetPasswordUseCase(mockUserRepository.Object);
            ...
            var response = await useCase.Handle(new ResetPasswordRequest("firstName", "newPassword"), mockOutputPort.Object);
